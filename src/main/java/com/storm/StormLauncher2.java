...
*/
        ...
        builder.setBolt("kafka-bolt", new ConsumerBolt(), 2).globalGrouping("identity");

        // Submit the topology
        Config conf = new Config();
        LocalCluster localCluster = new LocalCluster();
        localCluster.submitTopology("Kafka-Storm-Kafka", conf, builder.createTopology());
    }
}
